package com.rama.endecryptstr.activities
...
import com.rama.endecryptstr.databinding.ActivityEncryptBinding
import com.androidnetworking.interfaces.JSONObjectRequestListener
import com.google.android.material.snackbar.Snackbar
import com.rama.endecryptstr.network.ApiEndpoint
import org.json.JSONException
import org.json.JSONObject

class Encrpyt : AppCompatActivity() {

        private val binding: ActivityEncryptBinding by lazy {
        ActivityEncryptBinding.inflate(layoutInflater)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnEncrypt.setOnClickListener {
            ...
            if (strEncrypt.isEmpty()) {
                Toast.makeText(this@Encrpyt, "Form tidak boleh kosong!", Toast.LENGTH_SHORT).show()
            } else {
